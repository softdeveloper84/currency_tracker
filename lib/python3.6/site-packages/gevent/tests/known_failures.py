    ...
    if APPVEYOR:
        ...
        if PY3:
            FAILING_TESTS += [
                ...
                #     File "c:\projects\gevent\utils\gevent\threadpool.py", line 261 in _worker

                #   Thread 0x00000600 (most recent call first):
                #     File "c:\projects\gevent\utils\gevent\libuv\watcher.py", line 577 in send
                #     File "c:\projects\gevent\utils\gevent\threadpool.py", line 408 in set
                #     File "c:\projects\gevent\utils\gevent\threadpool.py", line 290 in _worker
